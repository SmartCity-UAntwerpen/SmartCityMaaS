...
public class GraphBuilder {
        ...
        for (Link link : linkCollection) {
            ...
            switch (vehicle) {
                ...
                case "WAIT":
                    ...
                    continue;
                default:
                    System.out.println("no supported vehicle was given. See graphbuilder class " + link.getVehicle());
                    link.setWeight(900L);
                    link.setVehicleID(5000L);
                    continue;
            }
            ...
            try {
                ...
                System.out.println("Received costs: " + Arrays.toString(costs));
            ...
            if (costs == null || costs.length == 0) {
                System.out.println("FAULTY answer from " + vehicle + " cost is NULL, weight set to 999999!");
    ...
    //for testing purposes, of request cost from an address.
